package com.cinematica.foundation.mvi.desktop
...
import com.cinematica.foundation.viewmodel.desktop.ViewModel

/**
 * Abstract class that should be typically used for implementing [StateMachine].
 */
abstract class DesktopAbstractStateMachine<TState : UiState, TEvent : UiEvent, TEffect : UiEffect>(
